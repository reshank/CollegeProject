...
import { listBestSellerProducts } from "@api/product";
...
const BestSellingProducts = () => {
  ...
  useEffect(() => {
    let isMount = true;
    const getData = async () => {
      let data = await listBestSellerProducts({
  ...
  if (loading) {
    return (
      <Box bg="white" mt={5} p="5" borderRadius="lg" boxShadow="base">
        <Flex w="full" textAlign="center" flexDirection="column" py="50px">
          <Heading fontSize="xl">Best selling products</Heading>
          <Text color="grey" mt="2">
            All the list of best selling/ featured products
          </Text>
        </Flex>
  ...
  return (
    <div id="featuredProducts">
      ...
      >
        ...
        <SimpleGrid columns={[1, 2, 3, 4, 5]} spacing={5} pt={5}>
